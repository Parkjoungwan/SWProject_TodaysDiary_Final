        ...
        <div class="row">
            <table class= "table table-striped" style="text-align: center; border: 1px solid #dddddd";>
                ...
                <tbody>
                    ...
                    <tr>
              			<td>작성일자</td>
              			<td colspan="2"><%= diary.getUserAge() %></td>
                    </tr>
                     <tr>
              			<td>내용</td>
              			<td colspan="2" style="height: 200px; text-align: left;"><%= diary.getDiaryContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") %></td>
                    </tr>
                </tbody>                      
            </table>
            ...
            %>
            		<a href="update.jsp?diaryID=<%=diaryID %>" class="btn btn-primary">수정</a>
            		<a onclick="return confirm('정말로 삭제하시겠습니까?')" href="deleteAction.jsp?diaryID=<%=diaryID %>" class="btn btn-primary">삭제</a>
            <%
            	}
            %> 
        </div>
