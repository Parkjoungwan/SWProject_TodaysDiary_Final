 ...
 * Generated at: 2019-11-19 17:54:36 UTC
...
return;
    ...
    try {
      ...
      out.write("              \t\t\t<td colspan=\"2\">");
      out.print( diary.getDiaryDate().substring(0,11)+diary.getDiaryDate().substring(11,13)+"시"+diary.getDiaryDate().substring(14,16)+"분" );
      out.write("</td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                    <tr>\r\n");
      out.write("              \t\t\t<td>작성일자</td>\r\n");
      out.write("              \t\t\t<td colspan=\"2\">");
      out.print( diary.getUserAge() );
      out.write("</td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                     <tr>\r\n");
      out.write("              \t\t\t<td>내용</td>\r\n");
      out.write("              \t\t\t<td colspan=\"2\" style=\"height: 200px; text-align: left;\">");
      out.print( diary.getDiaryContent().replaceAll(" ", "&nbsp;").replaceAll("<", "&lt;").replaceAll(">", "&gt;").replaceAll("\n", "<br>") );
      out.write("</td>\r\n");
      out.write("                    </tr>\r\n");
      out.write("                </tbody>                      \r\n");
      out.write("            </table>\r\n");
      out.write("            <a href=\"diary.jsp\" class=\"btn btn-primary\">목록</a>\r\n");
      out.write("            ");

            	if(userID != null && userID.equals(diary.getUserID())){
            
      out.write("\r\n");
      out.write("            \t\t<a href=\"update.jsp?diaryID=");
      out.print(diaryID );
      out.write("\" class=\"btn btn-primary\">수정</a>\r\n");
      out.write("            \t\t<a onclick=\"return confirm('정말로 삭제하시겠습니까?')\" href=\"deleteAction.jsp?diaryID=");
      out.print(diaryID );
